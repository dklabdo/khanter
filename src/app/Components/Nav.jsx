      ...
      <div className="w-full   flex items-center px-2 md:px-5 justify-between  h-14    ">
        ...
        <div className="items-center flex lg:hidden gap-1 ">
          <button
            ...
            className="text-sm scale-90 text-white  transition-all cursor-pointer font-light rounded-md  px-2 py-2  flex-row-reverse flex gap-1 items-center  "
          >
            {" "}
      ...
      {show && (
        <div className="max-w-screen w-full h-[200px] ">
          <ul className=" px-5 pt-5 flex text-black flex-col gap-3  ">
            <li className="flex group hover:text-white justify-between   cursor-pointer ">
              Home{" "}
              <ChevronRight
                size={22}
            ...
            <li className="flex group justify-between  hover:text-white cursor-pointer ">
              About{" "}
              <ChevronRight
                size={22}
                className=" group-hover:text-white"
